namespace CollegeManagementSystem.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CollegeManagementSystem.DAL.CollegeContext>
    {
        ...
        protected override void Seed(CollegeManagementSystem.DAL.CollegeContext context)
        {
            #region original seed data
        ...
        void AddOrUpdateInstructor(CollegeContext context, string courseTitle, string instructorName)
        {
